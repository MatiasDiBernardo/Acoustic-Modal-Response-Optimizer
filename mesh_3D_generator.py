...
def generate_mesh(floor_coords, Z, source_position, source_radio):
    ...
    Args:
        ...
        source_radio (float): Radio of the pulsating sphere
    """
    ...
    # 3) Pull out cell_data for those tets, e.g. physical tags
    tetra_data = {}
    ...
    # 4) Write a clean .msh containing only tets
    clean = meshio.Mesh(
        points=msh.points,
        cells=tetra_cells,
        cell_data=tetra_data
    )
    meshio.write("room.msh", clean, file_format="msh")
