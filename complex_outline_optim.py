...
def find_complex_outline(Lx, Ly, Lz, Dx, Dy, source_position, receptor_position):
    # Dimensiones sala (en centímetros)
    Lx = Lx * 100       # Largo de la sala en X 
    Ly = Ly * 100       # Largo de la sala en Y
    Lz = Lz * 100       # Alto de la sala
    Dx = Dx * 100        # Delta X
    Dy = Dy * 100        # Delta Y
